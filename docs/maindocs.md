...
| --- | --- |
| **Pixel-Perfect UI** | Match Weavy's UI exactly — background, layout, spacing, fonts, node designs, animations, and scrolling behavior |
...
│    └── Output: [https://cdn.transloadit.com/](https://www.google.com/search?q=https://cdn.transloadit.com/)...
...
* [Weavy.ai](https://www.weavy.ai) — Reference application (create free account)
* [React Flow Documentation](https://reactflow.dev/)
* [Trigger.dev Documentation](https://trigger.dev/)
* [Clerk Documentation](https://clerk.com/)
* [Transloadit Documentation](https://transloadit.com/)
