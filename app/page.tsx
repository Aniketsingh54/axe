...
export default function Home() {
    ...
    const onScroll = () => {
      ...
      requestAnimationFrame(() => {
        ...
        if (footerRef.current) {
          ...
          setIsFooterCompact(footerTop < window.innerHeight * 0.3);
        }

        parallaxNodes.forEach((node) => {
          const speed = Number(node.dataset.parallax ?? "0");
          const offset = Math.max(-30, Math.min(38, y * speed));
  ...
  return (
    <main className="min-h-screen bg-[#f3f4f6] text-black">
      ...
      <section id="enterprise" className="bg-[#f7f8f8] px-4 py-20 text-black md:px-8" data-reveal>
        <div className="mx-auto max-w-[1520px]">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-6">
            <h3 className="text-[88px] leading-none tracking-[-0.05em] max-lg:text-[64px]">From Workflow</h3>
            <div className="h-14 w-24 rounded-full bg-[#e5ef91] p-2"><div className="h-10 w-10 rounded-full bg-black" /></div>
            <h3 className="text-[88px] leading-none tracking-[-0.05em] text-black/32 max-lg:text-[64px]">to App Mode</h3>
          </div>
      ...
      <footer ref={footerRef} id="pricing" className="relative overflow-hidden border-t border-white/10 bg-[#292b33] px-4 pb-14 pt-16 text-white md:px-8 md:pt-24" data-reveal>
        <Link
          ...
          className={`absolute right-0 top-0 z-20 hidden items-center justify-center bg-[#eef79e] leading-none text-black transition-all duration-300 ease-out hover:bg-[#f7ffbf] sm:inline-flex ${
            isFooterCompact
              ? "h-[34px] w-[92px] rounded-bl-lg text-[14px] tracking-[-0.01em]"
        ...
        <div className="mx-auto max-w-[1520px]">
          ...
          <div className="mt-14 grid gap-10 md:grid-cols-[1.1fr_1fr]">
            ...
            <div id="demo" className="grid grid-cols-3 gap-8 text-[13px] text-white/78">
              ...
              <div className="space-y-2">
                <div className="text-[11px] uppercase text-white/45">Company</div>
              ...
              <div className="space-y-2">
                ...
                <Link href="/workflows" className="block hover:text-white">Workflow Library</Link>
